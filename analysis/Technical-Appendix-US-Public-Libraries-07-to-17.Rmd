...
# PLS <- mutate(PLS, C_LEGBAS = as.factor(ifelse(1, "City/County",
#                                                ifelse(2, "Municipal Government",
#                                                       ifelse(3, "County/Parish",
#                                                              ifelse(4, "Library District",
#                                                                     ifelse(5, "Multi-Jurisdictional",
#                                                                            ifelse(6, "Native American Tribal Government",
#                                                                                   ifelse(7, "Non-Profit Association or Agency",
#                                                                                          ifelse(8, "School District", "Other")
#                                                                                          )
#                                                                                   )
#                                                                            )
#                                                                     )
